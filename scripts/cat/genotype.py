    ...
    def fill(self):
        ...
        while not matched:
            ...
            if index == 0:
                ...
                if ranges[index-1] < self.unders_rufsum or self.unders_rufsum > ranges[index]:
                    matched = False
        ...
        while not matched:
            ...
            if index == 0:
                ...
                if ranges[index-1] < self.spotsum or self.spotsum > ranges[index]:
                    matched = False
        ...
        while not matched:
            ...
            if index == 0:
                ...
                if ranges[index-1] < self.ticksum or self.ticksum > ranges[index]:
                    matched = False
        ...
        while not matched:
            ...
            if index == 0:
                ...
                if ranges[index-1] < self.bengsum or self.bengsum > ranges[index]:
                    matched = False
        ...
        while not matched:
            ...
            if index == 0:
                ...
                if ranges[index-1] < self.soksum or self.soksum > ranges[index]:
                    matched = False
            if not matched:
                self.sokoke = ""
                self.soksum = 0
