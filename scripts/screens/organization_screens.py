...
class StartScreen(base_screens.Screens):
    ...
    def screen_switches(self):
        self.title = pygame_gui.elements.UITextBox("ClanGen CatMaker\nGenetics Mod Edition", pygame.Rect((0, 150), (800, 150)),
                                                   object_id="#title")
        self.start_button = pygame_gui.elements.UIButton(pygame.Rect((350, 320), (100, 50)), "Start")
        self.version = pygame_gui.elements.UITextBox("Version 0.9"
                                                     "\n Please don't sell any images created, and give proper credit. \n Credit to Key for original version!", pygame.Rect((250, 400), (300, 150)),
                                                     object_id="#version")
