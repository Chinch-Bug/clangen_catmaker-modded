...
genemod_white = bidict({None: 'None',
                        ...
                        'None6' : '-Head-',
                        'chin' : 'White Chin', 'mustache' : 'Mustache', 'muzzle1': 'Muzzle', 'muzzle2': 'Muzzle 2', 'blaze' : 'Blaze', 'break/nose1' : 'Coloured Nose Patch', 'break/nose2' : 'Coloured Nose', 'break/LEFTEAR' : 'No Left Ear', 'break/RIGHTEAR' : 'No Right Ear', 'break/left face' : 'No Left Mask', 'break/right face' : 'No Right Mask', 'break/bowl cut' : 'Head Patch',
                        'None7' : '-Dorsal-', 
